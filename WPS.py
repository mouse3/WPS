...
def aireplayng():
    ...
    os.system("ifconfig" + interfaz + "down")
    os.system("macchanger -a "+interfaz+";")
    os.system("ifconfig" + interfaz + "up")
    os.system("airodump-ng "+interfaz+"")
    Esid = str(input("Name:"))
    STATION = str(input("STATION:"))
    os.system("airodump-ng deauth 2000000 -e "+Esid+" -c "+STATION+" -ignore-negative-one "+interfaz+"")
def airodump():
    os.system("ifconfig")
    interfazo = input("interfaz:>")
    os.system("ifconfig" + interfazo + "down")
    os.system("macchanger -a "+interfazo+";")
    os.system("ifconfig" + interfazo + "up")
    os.system("airodump-ng "+interfazo+"")
    BSSID = str(input("BSSID:"))
    Canal = str(input("Canal:"))
    Nombre = str(input("Nombre:"))
    os.system("airodump-ng -c "+Canal+" -w "+Nombre+ "-bssid "+BSSID+"")
...
if WH == "11":
    aireplayng()
if WH == "12":
    aaa = input("install?>Y or N>")
    if aaa == "Y":
        os.system("git clone https://github.com/bitbrute/evillimiter.git && cd evillimiter && sudo python3 setup.py install")
    if aaa == "N":
        os.system("evillimiter")
if WH == "13":
    install = input("install? Y or N?>")
    if install == "Y":
        os.system("	git clone https://github.com/LandGrey/pydictor.git")
        os.system("	mv /pydictor /*")
        os.system("chmod +x pydictor.py")
    if install == "N":
        minimo = str(input("caracter.min>"))
        maximo = str(input("caracter.max>"))
        caracteres = str(input("caracteres(d, L, c):"))
        ubicacion = str(input(">"))
        print("ubication /root/User/WPS/worldlist")
        os.system("sudo ./pydictor.py --len "+minimo+" "+maximo+" -base "+caracteres+" -o "+ubicacion+"")
if WH == "14":
    os.system("sudo python3 WT.py")
if WH == "15":
    airodump()  
